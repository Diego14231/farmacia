...
const DICCIONARIO: Array<[RegExp, Cond]> = [
  ...
  [/\b(ALPRAZOLAM|CLONAZEPAM|DIAZEPAM|LORAZEPAM|MIDAZOLAM|ZOLPIDEM|ZOPICLONA|METILFENIDATO|MORFINA|METADONA|FENTANIL|OXICODONA|QUETIAPINA|OLANZAPINA|RISPERIDONA|HALOPERIDOL)\b/i, "receta_cheque"],
  ...
  [
    /\b(AMOXICILINA|ACICLOVIR|AZITROMICINA|CEFADROXILO|CEFUROXIMO|CEFTRIAXONA|CIPROFLOXACINO|CLARITROMICINA|CLINDAMICINA|CLORANFENICOL|DOXICICLINA|LEVOFLOXACINO|MOXIFLOXACINO|METRONIDAZOL|FLUCONAZOL|KETOCONAZOL|TERBINAFINA|ITRACONAZOL|NISTATINA|LOSARTAN|VALSART[AÁ]N|ENALAPRIL|OLMESARTAN|ATORVASTATINA|ROSUVASTATINA|METFORMINA|GLIBENCLAMIDA|SITAGLIPTINA|LINAGLIPTINA|EMPAGLIFLOZINA|LEVOTIROXINA|SERTRALINA|FLUOXETINA|PAROXETINA|ESCITALOPRAM|CITALOPRAM|VENLAFAXINA|DULOXETINA|DESVENLAFAXINA|MIRTAZAPINA|TRAZODONA|AMITRIPTILINA|BUPROPION|MELOXICAM|DICLOFENACO|NAPROXENO|KETOROLACO|KETOPROFENO|CELECOXIB|ETORICOXIB|CLONIXINATO|ACIDO MEFENAMICO|PREDNISONA|DEXAMETASONA|FLUNARIZINA|DOMPERIDONA|METOCLOPRAMIDA|ONDANSETR[OÓ]N|OLOPATADINA|SILDENAFIL|TADALAFILO?|FINASTERIDE?A?|LEVONORGESTREL|ETINILESTRADIOL|DIENOGEST|DROSPIRENONA|DESOGESTREL|TIBOLONA|MONTELUKAST|SALBUTAMOL|SALMETEROL|BUDESONIDA|FLUTICASONA|FORMOTEROL|TIOTROPIO|BETAMETASONA|CLOBETASOL|CLOTRIMAZOL\/BETAMETASONA|BISOPROLOL|AMLODIPINO|CARVEDILOL|ATENOLOL|PROPRANOLOL|NEBIVOLOL|HIDROCLOROTIAZIDA|CLORTALIDONA|FUROSEMIDA|ESPIRONOLACTONA|ACETAZOLAMIDA|ESOMEPRAZOL|PANTOPRAZOL|LANSOPRAZOL|CARBAMAZEPINA|LEVETIRACETAM|OXIBUTININA|TAMSULOSINA|OTILONIO|MEMANTINA|RIVAROXAB[AÁ]N|RUPATADINA|ACIDO VALPROICO)\b/i,
    "receta_simple",
  ],
  ...
  [/\b(PARACETAMOL|IBUPROFENO|AMBROXOL|BROMHEXINA|LORATADINA|DESLORATADINA|CETIRIZINA|LEVOCETIRIZINA|BILASTINA|FEXOFENADINA|CLORFENAMINA|DIMENHIDRINATO|LOPERAMIDA|ATAPULGITA|OMEPRAZOL|RANITIDINA|FAMOTIDINA|HIDROCORTISONA|ACIDO ACETILSALICILICO|ACIDO FOLICO|ASPIRINA|SUBSALICILATO|GUAIFENESINA|SIMETICONA|MACROGOL|MENTOL|MELATONINA|CLOTRIMAZOL|MICONAZOL|CALAMINA|ALBENDAZOL|COLECALCIFEROL|HIERRO|SACCHAROMYCES|CONDROITINA)\b/i, "directa"],
];
