...
const DICCIONARIO: Array<[RegExp, Cond]> = [
  ...
  [/\b(ALPRAZOLAM|CLONAZEPAM|DIAZEPAM|LORAZEPAM|MIDAZOLAM|ZOLPIDEM|METILFENIDATO|MORFINA|METADONA|FENTANIL|OXICODONA|QUETIAPINA|OLANZAPINA|RISPERIDONA)\b/i, "receta_cheque"],
  ...
  [
    /\b(AMOXICILINA|ACICLOVIR|AZITROMICINA|CEFADROXILO|CEFUROXIMO|CEFTRIAXONA|CIPROFLOXACINO|CLARITROMICINA|CLINDAMICINA|DOXICICLINA|LEVOFLOXACINO|MOXIFLOXACINO|METRONIDAZOL|FLUCONAZOL|KETOCONAZOL|TERBINAFINA|ITRACONAZOL|LOSARTAN|ENALAPRIL|VALSARTAN|ATORVASTATINA|ROSUVASTATINA|METFORMINA|GLIBENCLAMIDA|SITAGLIPTINA|LEVOTIROXINA|SERTRALINA|FLUOXETINA|PAROXETINA|ESCITALOPRAM|VENLAFAXINA|MELOXICAM|DICLOFENACO|NAPROXENO|KETOROLACO|PREDNISONA|DEXAMETASONA|FLUNARIZINA|DOMPERIDONA|OLOPATADINA|SILDENAFIL|TADALAFIL|FINASTERIDE|LEVONORGESTREL|ETINILESTRADIOL|DIENOGEST|DROSPIRENONA|DESOGESTREL|MONTELUKAST|SALBUTAMOL|SALMETEROL|BUDESONIDA|FLUTICASONA|FORMOTEROL|TIOTROPIO|BETAMETASONA|CLOTRIMAZOL\/BETAMETASONA)\b/i,
    "receta_simple",
  ],
  // Directa (OTC comun, incluye topicos/antifungicos topicos leves)
  [/\b(PARACETAMOL|IBUPROFENO|AMBROXOL|BROMHEXINA|LORATADINA|CETIRIZINA|CLORFENAMINA|DIMENHIDRINATO|LOPERAMIDA|OMEPRAZOL|RANITIDINA|ACIDO ACETILSALICILICO|GUAIFENESINA|SIMETICONA|MACROGOL|MENTOL|MELATONINA|CLOTRIMAZOL|MICONAZOL|CALAMINA)\b/i, "directa"],
];
